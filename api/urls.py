...
urlpatterns = [
    ...
    path('text-posts/', TextPostCreateView.as_view(), name='textpost-create'),
    path('text-posts/<int:pk>/', TextPostDetailView.as_view(),
         name='textpost-detail'),

    path('image-posts/', ImagePostCreateView.as_view(), name='imagepost-create'),
    path('image-posts/<int:pk>/', ImagePostDetailView.as_view(),
         name='imagepost-detail'),

    path('video-posts/', VideoPostCreateView.as_view(), name='videopost-create'),
